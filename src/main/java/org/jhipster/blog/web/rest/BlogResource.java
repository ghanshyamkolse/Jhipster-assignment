...
public class BlogResource {
     ...
     *         body the new blog, or with status {@code 400 (Bad Request)} if the
     ...
     *         the updated blog, or with status {@code 400 (Bad Request)} if the
     *         blog is not valid, or with status {@code 500 (Internal Server Error)}
     *         if the blog couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/blogs/{id}")
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the updated blog, or with status {@code 400 (Bad Request)} if the
     *         blog is not valid, or with status {@code 404 (Not Found)} if the blog
     *         is not found, or with status {@code 500 (Internal Server Error)} if
     *         the blog couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the blog, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/blogs/{id}")
